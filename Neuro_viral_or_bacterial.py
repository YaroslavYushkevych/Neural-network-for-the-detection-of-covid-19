...
train_path = pathlib.Path("E:/Neuro/archive/chest_xray_2/train")
test_path = pathlib.Path("E:/Neuro/archive/chest_xray_2/test")
val_path = pathlib.Path("E:/Neuro/archive/chest_xray_2/val")


X_train,y_train,Nombre_classes,Classes = lire_images("E:/Neuro/archive/chest_xray_2/train", 224, 224, 1000)
X_test,y_test,Nombre_classes,Classes = lire_images("E:/Neuro/archive/chest_xray_2/test", 224, 224, 1000)
X_val,y_val,Nombre_classes,Classes = lire_images("E:/Neuro/archive/chest_xray_2/val", 224, 224, 1000)
...
model.save('bac_viral_A_dence.h5')
...
train_dir = (r"E:/Neuro/archive/chest_xray_2/train")
test_dir = (r"E:/Neuro/archive/chest_xray_2/test")
...
predict_path=r'E:/Neuro/archive/chest_xray_2/test\VIRAL\person1_virus_9.jpeg'
...
model.save('bac_viral_B_dence.h5')